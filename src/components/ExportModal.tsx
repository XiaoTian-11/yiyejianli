                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between pt-1">
                    ...
                    <button
                      ...
                      className="px-6 py-2.5 bg-slate-900 hover:bg-slate-800 text-white rounded-xl text-[11px] font-black shadow-lg hover:scale-105 active:scale-95 transition-all flex items-center gap-1.5 cursor-pointer"
                    >
