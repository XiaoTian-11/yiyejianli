...
import { Plus, Trash2, ChevronDown, ChevronUp, AlertCircle, GripVertical, Bold, Italic, Underline, Info, Globe } from 'lucide-react';
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-5 bg-gradient-to-r from-blue-550/5 from-blue-50 to-indigo-50/50 rounded-3xl border border-blue-100/60 gap-4 mt-3">
            <div className="space-y-1">
              ...
              <p className="text-[11px] text-slate-500 leading-normal">
                使用极速的 <b>Gemini CV translation engine</b> 把您当前已经填写的简历内容翻译为所选的<b>{LANGUAGES.find(l=>l.code===data.secondaryLanguage)?.name}</b>，可省去逐词手动填写的繁琐。
              </p>
            </div>
            <button
              type="button"
