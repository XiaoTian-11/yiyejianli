                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-slate-50/80 p-4 rounded-3xl border border-slate-100/50 flex flex-col sm:flex-row gap-4 justify-around">
                    <div className="flex items-center gap-2.5">
                      ...
                      <span className="text-xs font-bold text-slate-700">500+ 会员专属精美模板</span>
                    </div>
                    <div className="flex items-center gap-2.5">
                    ...
                    <div className="flex items-center gap-2.5">
                      ...
                      <span className="text-xs font-bold text-slate-700">智能 ATS 初筛竞争力优化</span>
                    </div>
                  </div>
                ...
                <div className="flex flex-col items-center justify-center py-12 text-center space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 text-xs mt-1">
                      您的账户已经升级为：<span className="text-amber-600 font-bold bg-amber-50 px-2 py-0.5 rounded ml-1">尊享会员 (年卡套餐)</span>
                    </p>
                  </div>
